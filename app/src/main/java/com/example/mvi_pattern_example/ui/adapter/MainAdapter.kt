package com.example.mvi_pattern_example.ui.adapter
...
import com.example.mvi_pattern_example.R
...
class MainAdapter(private val users: ArrayList<User>) :
    ...
    class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(user: User) {
            ...
            itemView.findViewById<TextView>(R.id.textViewUserEmail).text = user.name
